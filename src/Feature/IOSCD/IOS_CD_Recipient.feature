...
Feature: Recipient Functionality :
  ...
  @CD_PID-3605_TC170 @CD_iOS_sanity @CD_Lot17 @CD_Resolve5 @CD_iOS_2FA
  ...
  #| CDAuthorisedSIT3   | CDRegEmailPass1 | Company       | Tata Services | India   | INR      | IndiaAdd |      12345678 | IFSC         | SBIN0000575 | UAT         |
  @CD_PID-3605_TC171 @CD_iOS_2FA
  Scenario Outline: 3.17 3.18 To verify when user enters all mandatory recipient data and completes OTP process then user should navigate to updated recipient list screen with newly added recipient at the top of list.
    Given ios user installed the new CD app and launched successfully
    Then ios app should load the onboarding screen
    When ios user click on I already have an account? link
  ...
  @CD_CD_PID-3605_TC172 @CD_iOS_2FA
  Scenario Outline: 3.17 3.18 To verify when user enters all mandatory recipient data and completes OTP process then user should navigate to updated recipient list screen with newly added recipient at the top of list.
    Given ios user installed the new CD app and launched successfully
    Then ios app should load the onboarding screen
    When ios user click on I already have an account? link
  ...
  @CD_PID-3610_TC144 @CD_iOS_regression @CD_Lot16
  ...
  @CD_PID-3610_TC145 @CD_iOS_sanity @CD_Lot16 @CD_Resolve6
  ...
  @CD_PID-3607_TC0150 @CD_iOS_regression @CD_Lot14
  ...
  @CD_PID-3605_TC1651 @CD_Lot10 @CD_Resolve18 @CD_iOS_2FA
  ...
  @CD_PID-3605_TC173 @CD_Lot9 @CD_Resolve19 @CD_iOS_2FA
  ...
  @CD_PID-3605_TC1712 @CD_Lot5 @CD_Resolve27 @CD_iOS_2FA
  ...
  @CD_PID-3609_TC188 @CD_Lot5 @CD_Resolve28 @CD_iOS_2FA
  ...
  #addressField :Addressline1,City,PostCode
  #bankField:AccountNumber,ABA,IBAN,SWIFT,SORT,IFSC,BSB,Transit
  @CD_PID-3609_TC189 @CD_Lot4 @CD_Resolve29 @CD_iOS_2FA
  ...
  @CD_PID-3609_TC190 @CD_Lot4 @CD_Resolve30 @CD_iOS_2FA
  ...
  @CD_PID-3609_TC192 @CD_Lot4 @CD_Resolve31 @CD_iOS_2FA
  ...
  #| CDRegEmailId28 | CDRegEmailPass1 | Individual       | Dam Watsons   | USA     | USD      | USAAdd  | 12345678      | ABA          | 083900363 | UAT         | FirstName-Dam,LastName-Watsons     | ABA-026009593,AccountNumber-12345678 | Addressline1-Street ABC,City-New York,PostCode-US3256 |
  @CD_PID-3609_TC193 @CD_Lot3 @CD_Resolve32 @CD_iOS_2FA
  ...
  @CD_PID-3609_TC194 @CD_Lot3 @CD_Resolve33 @CD_iOS_2FA
  ...
  @CD_PID-3609_TC195 @CD_Lot3 @CD_Resolve35 @CD_iOS_2FA
