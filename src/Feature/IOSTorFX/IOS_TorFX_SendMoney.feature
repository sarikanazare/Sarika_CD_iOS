...
Feature: Dashboard send money functionality :
  ...
  @TorFX_PID-3790_TC01 @TorSendMoney_lot1
  ...
  @TorFX_PID-3791_TC02 @TorSendMoney_lot1
  Scenario Outline: 2.1 2.2 Selling currency : To verify that amount get calculated in sell currency when user entered amount in they get field
    ...
    Examples: 
      ...
      | TorRegEmailId03 | CDRegEmailPass1 | 2,000.28 |

  @TorFX_PID-3791_TC03 @Torfx_iOS_regression @TorSendMoney_lot1
  Scenario Outline: 2.3 Selling currency : To verify that when amount entered in selling currency is less than allowed limit (100 GBP) error message to be displayed
    ...
    Examples: 
      | emailAddress    | password        | amount |
      | TorRegEmailId01 | CDRegEmailPass1 |  01.00 |

  #| CDRegEmailId | CDRegEmailPass |   1.00 |
  @TorFX_PID-3791_TC04 @Torfx_iOS_regression @TorSendMoney_lot1
  Scenario Outline: 2.4 Selling currency :  To verify that when amount entered in selling currency is greater than allowed GBP limit (25000 GBP)  error message to be displayed :
    ...
    Examples: 
      | emailAddress    | password        | amount    |
      | TorRegEmailId01 | CDRegEmailPass1 | 26,000.01 |

  @TorFX_PID-3791_TC05 @TorSendMoney_lot1
  Scenario Outline: 2.1 2.2 2.6 2.5 2.9 buying currency : To verify that amount get calculated in buying currency when user entered amount in you pay field
    ...
    Examples: 
      | emailAddress    | password        | amount   |
      | TorRegEmailId03 | CDRegEmailPass1 | 1,010.50 |

  @TorFX_PID-3791_TC06 @TorSendMoney_lot1
  Scenario Outline: 2.7 Buying currency : To verify that when amount entered in buying currency such that calculated amount in selling currency is less than 100 GBP error message to be displayed :
    ...
    Examples: 
      | emailAddress    | password        | amount |
      | TorRegEmailId03 | CDRegEmailPass1 |  99.00 |

  @TorFX_PID-3791_TC07 @TorSendMoney_lot1
  Scenario Outline: 2.8 Buying currency : To verify that when amount entered in buying currency such that calculated amount in selling currency is greater than allowed GBP (25000 GBP) error message to be displayed :
    ...
    Examples: 
      | emailAddress    | password        | amount    |
      | TorRegEmailId03 | CDRegEmailPass1 | 50,000.00 |

  @TorFX_PID-3791_TC08 @TorSendMoney_lot1
  Scenario Outline: 2.11 2.13 : To Verify after 60 sec rate gets refreshed and they get amount gets updated as amount is entered in selling currency.
    ...
    Examples: 
      | emailAddress    | password        | amount    |
      | TorRegEmailId03 | CDRegEmailPass1 | 14,001.00 |

  @TorFX_PID-3791_TC09 @TorSendMoney_lot1
  Scenario Outline: 2.11 2.14 To Verify after 60 sec rate gets refreshed  and you pay amount gets updated as amount is entered in buying currency.
    ...
    Examples: 
      ...
      | TorRegEmailId03 | CDRegEmailPass1 | 10,001.00 |      60 |

  @TorFX_PID-3791_TC10 @Torfx_iOS_regression @TorSendMoney_lot1
  Scenario Outline: 2.12 To verify Fx deal rates are fetched again and the timer gets resets after every 60 second when user enters amount in you pay field
    ...
    Examples: 
      | emailAddress    | password        | amount    |
      | TorRegEmailId01 | CDRegEmailPass1 | 14,001.00 |

  @TorFX_PID-3791_TC11 @Torfx_iOS_regression @TorSendMoney_lot1
  Scenario Outline: 2.12 To verify Fx deal rates are fetched again and the timer gets resets after every 60 second when user enters amount in they get
    ...
    Examples: 
      | emailAddress    | password        | amount    |
      | TorRegEmailId01 | CDRegEmailPass1 | 16,001.00 |

  @TorFX_PID-3792_TC12 @TorSendMoney_lot1
  Scenario Outline: They get currency drop down: To verify on click of back arrow on drop down page user should be lands on send money page.
    ...
    Examples: 
      ...
      | TorRegEmailId03 | CDRegEmailPass1 | CAD             |

  @TorFX_PID-3792_TC13 @TorSendMoney_lot1
  Scenario Outline: You pay currency drop down: To verify on click of back arrow on drop down page user should be lands on send money page.
    ...
    Examples: 
      ...
      | TorRegEmailId03 | CDRegEmailPass1 | AUD            |

  @TorFX_PID-3792_TC14 @Torfx_iOS_regression @TorSendMoney_lot1
  Scenario Outline: 3.2, 3.3 You pay drop down : To verify the that user should be able to search currency.
    ...
    Examples: 
      | emailAddress    | password        | youPayCurrency |
      | TorRegEmailId01 | CDRegEmailPass1 | GBP            |

  @TorFX_PID-3792_TC15 @TorSendMoney_lot1
  Scenario Outline: 3.2, 3.3 They get drop down : To verify the that user should be able to search currency.
    ...
    Examples: 
      | emailAddress    | password        | theyGetCurrency |
      | TorRegEmailId03 | CDRegEmailPass1 | USD             |

  #| CDRegEmailId | CDRegEmailPass | US Dollar       |
  @TorFX_PID-3792_TC16 @TorSendMoney_lot1
  Scenario Outline: 3.2, 3.3 You pay currency drop down : To verify enter serach data gets cleared when user selects (x) option
    ...
    Examples: 
      ...
      | TorRegEmailId03 | CDRegEmailPass1 | EUR            | USD             |

  @TorFX_PID-3792_TC17 @TorSendMoney_lot1
  Scenario Outline: 3.2, 3.3 They get currency drop down : To verify enter serach data gets cleared when user selects (x) option
    ...
    Examples: 
      | emailAddress    | password        | youPayCurrency | theyGetCurrency |
      | TorRegEmailId03 | CDRegEmailPass1 | EUR            | CAD             |

  @TorFX_PID-3792_TC18 @TorSendMoney_lot1
  Scenario Outline: 3.5  You pay currency drop down: To verify that after selecting currency, app should take the user to the home screen with the selected currency in selling currency.
    Given ios user installed the new TorFX app and launched successfully
    Then ios app should load the onboarding screen
    When ios user click on I already have an account? link
    Then ios user should navigate to login screen
  ...
  @TorFX_PID-3792_TC19 @TorSendMoney_lot1
  ...
  @TorFX_PID-3792_TC20 @Torfx_iOS_regression @TorSendMoney_lot1
  Scenario Outline: 3.8  To verify when user selects invalid currency pair then rate should not be fetch and error message to be displayed
    ...
    Examples: 
      | emailAddress    | password        | youPayCurrency | theyGetCurrency |
      | TorRegEmailId01 | CDRegEmailPass1 | DKK            | CZK             |

  @TorFX_PID-3793_TC21 @Torfx_iOS_regression @TorSendMoney_lot1
  Scenario Outline: 4.1 4.2 To verify when user selects swap option only currency should get swap and default selling amount should remain as is.
    ...
    Examples: 
      ...
      | TorRegEmailId01 | CDRegEmailPass1 | GBP            | EUR             | 1,000.00 |

  @TorFX_PID-3793_TC22 @TorSendMoney_lot1
  Scenario Outline: 4.1 4.2 To verify when user selects  swap option only currency should get swap and default you pay amount should remain as is.
    ...
    Examples: 
      | emailAddress    | password        | youPayCurrency | theyGetCurrency | amount  |
      | TorRegEmailId03 | CDRegEmailPass1 | GBP            | EUR             | 2500.26 |

  @TorFX_PID-3793_TC23 @TorSendMoney_lot1
  ...
  @TorFX_PID-3795_TC24 @TorSendMoney_lot1
  ...
  #This testcase is NA due to new changes in application default currency amount remains same
  @TorFX_PID-3795_TC25 @TorSendMoney_lot1
  Scenario Outline: 6.2 6.3 To verify on click of back arrow on select recipient page user should be lands on send money page and default currency pair and amount should be displayed in selling currency
    ...
    Examples: 
      ...
      | TorRegEmailId03 | CDRegEmailPass1 | GBP            | USD             | 2000.00 | GBP-EUR             |         1,000.00 |

  @TorFX_PID-3795_TC26 @TorSendMoney_lot2
  Scenario Outline: 6.4 To check that only those recipients are shown in the list, who can receive the buying currency, as selected by the user in the send money screen step1.
    ...
    Examples: 
      | emailAddress    | password        | youPayCurrency | theyGetCurrency | amount  |
      | TorRegEmailId03 | CDRegEmailPass1 | EUR            | GBP             | 2000.00 |

  @TorFX_PID-3795_TC27 @Torfx_iOS_regression @TorSendMoney_lot2
  Scenario Outline: 6.4 To verify that empty recipients screen gets displayed when selected buy currency recipient are not present in recipient list.
    ...
    Examples: 
      | emailAddress    | password        | youPayCurrency | theyGetCurrency | amount  |
      | TorRegEmailId01 | CDRegEmailPass1 | GBP            | ZAR             | 2000.00 |

  @TorFX_PID-3793_TC28 @TorSendMoney_lot2
  Scenario Outline: 6.5 6.6 To verify that application allow user to initiate add recipient process during send money journey currency field should be set to the Buy Currency of the Send Money and it should not be editable.
    ...
    Examples: 
      ...
      | TorRegEmailId03 | CDRegEmailPass1 | GBP            | EUR             | 2000.00 | France  |
  ...
  @TorFX_PID-3793_TC29 @Torfx_iOS_regression @TorSendMoney_lot2 @TorFX_iOS_2FA
  Scenario Outline: 6.7 7.1 To verify that user lands on payment method page once user completes the add recipient process during the send money journey
    ...
    Examples: 
      ...
      | TorRegEmailId03 | CDRegEmailPass1 | GBP            | USD             | 200.00 | Individual    | harsheyss7 peteross5 | USA     | USD      | USAAdd  |  12345675 | ABA          | 083900363 |

  @TorFX_PID-3793_TC30 @TorSendMoney_lot2
  Scenario Outline: 6.8 To verify that user lands on payment method page once user selects the recipient from the available recipient list during the send money journey
    ...
    Examples: 
      | emailAddress    | password        | youPayCurrency | theyGetCurrency | amount | recipientType | recipientName   | country | currency | address | accountNo | bankCodeType | bankCode  |
      | TorRegEmailId03 | CDRegEmailPass1 | EUR            | USD             | 200.00 | Individual    | Andrew Peterson | USA     | USD      | USAAdd  |  12345675 | ABA          | 083900363 |

  @TorFX_PID-3796_TC31 @TorSendMoney_lot2
  ...
  @TorFX_PID-3796_TC32 @TorSendMoney_lot2
  ...
  @TorFX_PID-3797_TC33 @TorSendMoney_lot2
  ...
  @TorFX_PID-3797_TC34 @TorSendMoney_lot2
  Scenario Outline: 7.11 To verify that user can add new card successfully and user should land card list page where recently added card displayed during send money journey.
    ...
    Examples: 
      ...
      | TorRegEmailId03 | CDRegEmailPass1 | EUR            | USD             | 200.00 | Individual    | Andrew Peterson | USA     | USD      | USAAdd  |  12345675 | ABA          | 083900363 | Samsss Petro   | 6759649826438453 |            1120 |             1125 |

  @TorFX_PID-3797_TC35 @Torfx_iOS_regression @TorSendMoney_lot2
  Scenario Outline: To verify that in send money flow while adding new card when last name does not match with the account holders last name the system should give proper error message
    ...
    Examples: 
      | emailAddress    | password        | youPayCurrency | theyGetCurrency | amount | recipientType | recipientName   | country | currency | address | accountNo | bankCodeType | bankCode  | cardHolderName | cardNumber       | issueDate(MMYY) | expiryDate(MMYY) |
      | TorRegEmailId03 | CDRegEmailPass1 | EUR            | USD             | 200.00 | Individual    | Andrew Peterson | USA     | USD      | USAAdd  |  12345675 | ABA          | 083900363 | matrin         | 6759649826438453 |            1120 |             1125 |

  @TorFX_PID-3797_TC36 @TorSendMoney_lot3
  Scenario Outline: To verify that in send money flow while adding new card when expiry date is less than current date than system should give proper error message
    ...
    Examples: 
      | emailAddress    | password        | youPayCurrency | theyGetCurrency | amount | recipientType | recipientName   | country | currency | address | accountNo | bankCodeType | bankCode  | cardHolderName | cardNumber       | issueDate(MMYY) | expiryDate(MMYY) |
      | TorRegEmailId03 | CDRegEmailPass1 | EUR            | USD             | 200.00 | Individual    | Andrew Peterson | USA     | USD      | USAAdd  |  12345675 | ABA          | 083900363 | Samsss Petro   | 6759649826438453 |            1120 |             1120 |

  @TorFX_PID-3797_TC37 @TorSendMoney_lot3
  Scenario Outline: To verify that in send money flow while adding new card when issue date is greater than current date then system should give proper error message
    ...
    Examples: 
      | emailAddress    | password        | youPayCurrency | theyGetCurrency | amount | recipientType | recipientName   | country | currency | address | accountNo | bankCodeType | bankCode  | cardHolderName | cardNumber       | issueDate(MMYY) | expiryDate(MMYY) |
      | TorRegEmailId03 | CDRegEmailPass1 | EUR            | USD             | 200.00 | Individual    | Andrew Peterson | USA     | USD      | USAAdd  |  12345675 | ABA          | 083900363 | Samsss Petro   | 6759649826438453 |            1125 |             1120 |

  @TorFX_PID-3797_TC38 @TorSendMoney_lot3
  ...
  @TorFX_PID-3797_TC39 @Torfx_iOS_regression @TorSendMoney_lot3
  Scenario Outline: 7.13 To verify that when user selects any card from available list then enter 2digit CVV field then continue button gets disabled
    ...
    Examples: 
      ...
      | TorRegEmailId03 | CDRegEmailPass1 | EUR            | USD             | 200.00 | Individual    | Andrew Peterson | USA     | USD      | USAAdd  |  12345675 | ABA          | 083900363 | Samsss Petro   | 6759649826438453 |            1120 |             1125 |  12 |

  @TorFX_PID-3797_TC40 @TorSendMoney_lot3
  Scenario Outline: 7.13 To verify that when user selects any card from available list then enter correct  CVV field then continue button gets enabled
    ...
    Examples: 
      ...
      | TorRegEmailId03 | CDRegEmailPass1 | EUR            | USD             | 200.00 | Individual    | Andrew Peterson | USA     | USD      | USAAdd  |  12345675 | ABA          | 083900363 | Samsss Petro   | 6759649826438453 |            1120 |             1125 | 555 | Sending to Family | Test-Reference |

  @TorFX_PID-3797_TC41 @Torfx_iOS_regression @TorSendMoney_lot3
  ...
  @TorFX_PID-3797_TC42 @TorSendMoney_lot3
  ...
  @TorFX_PID-3939_TC43 @TorSendMoney_lot3
  ...
  @TorFX_PID-3939_TC44 @TorSendMoney_lot3
  ...
  @TorFX_PID-3939_TC45 @Torfx_iOS_regression @TorSendMoney_lot3
  Scenario Outline: To verify that 'Payment reference' if not selected it should not be displayed on review and confirmation success page.
    ...
    Examples: 
      | emailAddress    | password        | youPayCurrency | theyGetCurrency | amount | recipientType | recipientName   | country | currency | address | accountNo | bankCodeType | bankCode  | cardHolderName | cardNumber       | issueDate(MMYY) | expiryDate(MMYY) | cvv | paymentReason     | reference      |
      # | CDRegEmailId28 | CDRegEmailPass1 | GBP            | USD             | 200.00 | Individual    | Andrew Peterson | USA     | USD      | USAAdd  |  12345675 | ABA          | 083900363 | jee            | 5555555555554444 |            1120 |             1125 | 555 | Sending to Family | Test-Reference |
      | TorRegEmailId03 | CDRegEmailPass1 | EUR            | USD             | 200.00 | Individual    | Andrew Peterson | USA     | USD      | USAAdd  |  12345675 | ABA          | 083900363 | Samsss Petro   | 5555555555554444 |            1120 |             1125 | 555 | Sending to Family | Test-Reference |
  ...
  Scenario Outline: 8.6.1 To verify when CDLGB user selects the T's & C's link,window should open with a link to the respective UK T's & C'
    ...
    Examples: 
      ...
      | TorRegEmailId03 | CDRegEmailPass1 | GBP            | USD             | 200.00 | Individual    | Andrew Peterson | USA     | USD      | USAAdd  |  12345675 | ABA          | 083900363 | samy jee       | 6759649826438453 |            1120 |             1125 | 555 | Sending to Family | Test-Reference | SIT         |
  ...
  Scenario Outline: 8.6.3 To verify that user lands on review page on click of back button or the device back button on UK T's & C window
    ...
    Examples: 
      | emailAddress    | password        | youPayCurrency | theyGetCurrency | amount | recipientType | recipientName   | country | currency | address | accountNo | bankCodeType | bankCode  | cardHolderName  | cardNumber       | issueDate(MMYY) | expiryDate(MMYY) | cvv | paymentReason     | reference      | environment |
      | TorRegEmailId03 | CDRegEmailPass1 | EUR            | USD             | 200.00 | Individual    | Andrew Peterson | USA     | USD      | USAAdd  |  12345675 | ABA          | 083900363 | George Browning | 6759649826438453 |            1120 |             1125 | 555 | Sending to Family | Test-Reference | SIT         |

  @TorFX_PID-3797_TC48 @TorSendMoney_lot4
  Scenario Outline: 8.7 To verify that in send money flow user is able to perform journey by using Non-3d NEW card user land and on success page with all mapped data.
    ...
    Examples: 
      | emailAddress    | password        | youPayCurrency | theyGetCurrency | amount | recipientType | recipientName   | country | currency | address | accountNo | bankCodeType | bankCode  | cardHolderName | cardNumber       | issueDate(MMYY) | expiryDate(MMYY) | cvv | paymentReason     | reference      | environment |
      | TorRegEmailId03 | CDRegEmailPass1 | GBP            | USD             | 200.00 | Individual    | Andrew Peterson | USA     | USD      | USAAdd  |  12345675 | ABA          | 083900363 | Samsss Petro   | 6759649826438453 |            1120 |             1125 | 555 | Sending to Family | Test-Reference | UAT         |

  #| CDRegEmailID34 | CDRegEmailPass1 | EUR            | USD             | 200.00 | Individual    | Andrew Peterson | USA     | USD      | USAAdd  |  12345675 | ABA          | 083900363 | Smith          | 5454545454545454 |            1120 |             1125 | 555 | Sending to Family | Test-Reference | UAT         |
  @TorFX_PID-3939_TC49 @TorSendMoney_lot4
  Scenario Outline: To verify android app displayed the error message when wrong CVV number entered for existing non 3d card
    ...
    Examples: 
      | emailAddress    | password        | youPayCurrency | theyGetCurrency | amount | recipientType | recipientName   | country | currency | address | accountNo | bankCodeType | bankCode  | cardHolderName | cardNumber       | issueDate(MMYY) | expiryDate(MMYY) | cvv | paymentReason     | reference      | environment |
      | TorRegEmailId03 | CDRegEmailPass1 | EUR            | USD             | 200.00 | Individual    | Andrew Peterson | USA     | USD      | USAAdd  |  12345675 | ABA          | 083900363 | Samsss Petro   | 5454545454545454 |            1120 |             1125 |  55 | Sending to Family | Test-Reference | UAT         |

  @TorFX_PID-3939_TC50 @TorSendMoney_lot4
  Scenario Outline: To verify android app displayed the error message when wrong CVV number entered for new Non 3d card
    ...
    Examples: 
      | emailAddress    | password        | youPayCurrency | theyGetCurrency | amount | recipientType | recipientName   | country | currency | address | accountNo | bankCodeType | bankCode  | cardHolderName | cardNumber       | issueDate(MMYY) | expiryDate(MMYY) | cvv | paymentReason     | reference      | environment |
      | TorRegEmailId03 | CDRegEmailPass1 | EUR            | USD             | 200.00 | Individual    | Andrew Peterson | USA     | USD      | USAAdd  |  12345675 | ABA          | 083900363 | Samsss Petro   | 5454545454545454 |            1120 |             1125 | 999 | Sending to Family | Test-Reference | SIT         |

  @TorFX_PID-3939_TC51 @TorFX_FraudSight_SendMoney_Cycle3 @TorSendMoney_lot4
  Scenario Outline: 8.10 To verify that new 3d card user land on “3d page” post submitting the review page
    ...
    Examples: 
      | emailAddress    | password        | youPayCurrency | theyGetCurrency | amount | recipientType | recipientName   | country | currency | address | accountNo | bankCodeType | bankCode  | cardHolderName | cardNumber       | issueDate(MMYY) | expiryDate(MMYY) | cvv | paymentReason     | reference      | environment |
      #| CDRegEmailId30 | CDRegEmailPass1 | EUR            | GBP             | 200.00 | Individual    | Andrew Peterson | Albania | GBP      | USAAdd  |  12345675 | ABA          | 083900363 | 3d             | 4462030000000000 |            1120 |             1125 | 555 | Sending to Family | Test-Reference | UAT         |
      | TorRegEmailId04 | CDRegEmailPass1 | EUR            | GBP             | 200.00 | Individual    | Andrew Peterson | Albania | GBP      | USAAdd  |  12345675 | ABA          | 083900363 | 3d             | 5454545454545454 |            1120 |             1125 | 555 | Sending to Family | Test-Reference | UAT         |

  #| CDRegEmailId32 | CDRegEmailPass4  | EUR            | GBP             | 200.00 | Individual    | Andrew Peterson | Albania | GBP      | USAAdd  |  12345675 | ABA          | 083900363 | 3d             | 4462030000000000 |            1120 |             1125 | 555 | Sending to Family | Test-Reference | UAT         |
  @TorFX_PID-3939_TC521 @Torfx_iOS_sanity @TorSendMoney_lot4
  Scenario Outline: 8.13 To verify that in send money flow user is able to perform journey by using existing 3d card user land and on success page and data get mapped.
    ...
    Examples: 
      | emailAddress    | password        | youPayCurrency | theyGetCurrency | amount | recipientType | recipientName   | country | currency | address | accountNo | bankCodeType | bankCode  | cardHolderName | cardNumber       | issueDate(MMYY) | expiryDate(MMYY) | cvv | paymentReason     | reference      | environment |
      | TorRegEmailId04 | CDRegEmailPass1 | EUR            | USD             | 200.00 | Individual    | Andrew Peterson | USA     | USD      | USAAdd  |  12345675 | ABA          | 083900363 | 3d             | 5555555555554444 |            1120 |             1125 | 555 | Sending to Family | Test-Reference | UAT         |

  @TorFX_PID-3939_TC53 @TorSendMoney_lot4
  Scenario Outline: To verify 3d card journey get successfully done when user click on back and forth page on 3d page.
    ...
    #Examples:
    # | emailAddress     | password        | youPayCurrency | theyGetCurrency | amount | recipientType | recipientName   | country | currency | address | accountNo | bankCodeType | bankCode  | cardHolderName | cardNumber       | issueDate(MMYY) | expiryDate(MMYY) | cvv | paymentReason | reference      | environment |
    #| CDRegEmailId30 | CDRegEmailPass1 | EUR            | USD             | 200.00 | Individual    | Andrew Peterson | USA     | USD      | USAAdd  |  12345675 | ABA          | 083900363 | 3d             | 6759649826438453 |            1120 |             1125 | 555 | Sending to Family | Test-Reference | SIT         |
    Examples: 
      | emailAddress    | password        | youPayCurrency | theyGetCurrency | amount | recipientType | recipientName   | country | currency | address | accountNo | bankCodeType | bankCode  | cardHolderName | cardNumber       | issueDate(MMYY) | expiryDate(MMYY) | cvv | paymentReason     | reference      | environment |
      | TorRegEmailId04 | CDRegEmailPass1 | EUR            | GBP             | 200.00 | Individual    | Andrew Peterson | Albania | GBP      | USAAdd  |  12345675 | ABA          | 083900363 | Samsss Petro   | 6759649826438453 |            1120 |             1125 | 555 | Sending to Family | Test-Reference | UAT         |

  @TorFX_PID-3939_TC54 @TorSendMoney_lot4
  Scenario Outline: To verify payment journey flow for New 3d card with wrong cvv.
    ...
    Examples: 
      | emailAddress    | password        | youPayCurrency | theyGetCurrency | amount | recipientType | recipientName   | country | currency | address | accountNo | bankCodeType | bankCode  | cardHolderName | cardNumber       | issueDate(MMYY) | expiryDate(MMYY) | cvv | paymentReason     | reference      | environment |
      | TorRegEmailId04 | CDRegEmailPass1 | EUR            | USD             | 200.00 | Individual    | Andrew Peterson | USA     | USD      | USAAdd  |  12345675 | ABA          | 083900363 | 3d             | 5555555555554444 |            1120 |             1125 | 444 | Sending to Family | Test-Reference | UAT         |
  ...
  Scenario Outline: 9.1,9.3,9.4 To verify that on click of done button on success page user should land on ‘Home’ (Send Money) screen
    ...
    Examples: 
      | emailAddress    | password       | youPayCurrency | theyGetCurrency | amount | recipientType | recipientName   | country | currency | address | accountNo | bankCodeType | bankCode  | cardHolderName | cardNumber       | issueDate(MMYY) | expiryDate(MMYY) | cvv | paymentReason     | reference      | environment |
      | TorRegEmailId03 | CDRegEmailPass | EUR            | USD             | 200.00 | Individual    | Andrew Peterson | USA     | USD      | USAAdd  |  12345675 | ABA          | 083900363 | 3d             | 4462030000000000 |            1120 |             1125 | 555 | Sending to Family | Test-Reference | UAT         |

  @TorFX_PID-3939_TC5200 @TorSendMoney_lot4
  Scenario Outline: 8.7 To verify that in send money flow user is able to perform journey by using 3d NEW card user land and on success page data get mapped.
    ...
    Examples: 
      | emailAddress    | password        | youPayCurrency | theyGetCurrency | amount | recipientType | recipientName   | country | currency | address | accountNo | bankCodeType | bankCode  | cardHolderName | cardNumber       | issueDate(MMYY) | expiryDate(MMYY) | cvv | paymentReason     | reference      | environment |
      | TorRegEmailId04 | CDRegEmailPass1 | EUR            | USD             | 200.00 | Individual    | Andrew Peterson | USA     | USD      | USAAdd  |  12345675 | ABA          | 083900363 | 3d             | 6759649826438453 |            1120 |             1125 | 555 | Sending to Family | Test-Reference | SIT         |

  @TorFX_PID-3798_TC01 @TorSendMoney_lot4
  Scenario Outline: 8.1 To verify that when user selects a payment reason then continue button should get enabled and clicking on it user should get navigate to review screen
    ...
    Examples: 
      | emailAddress    | password        | youPayCurrency | theyGetCurrency | amount | recipientType | recipientName   | country | currency | address | accountNo | bankCodeType | bankCode  | cardHolderName | cardNumber       | issueDate(MMYY) | expiryDate(MMYY) | cvv | paymentReason     | reference      | environment |
      | TorRegEmailId03 | CDRegEmailPass1 | EUR            | USD             | 200.00 | Individual    | Andrew Peterson | USA     | USD      | USAAdd  |  12345675 | ABA          | 083900363 | Samsss Petro   | 6759649826438453 |            1120 |             1125 | 555 | Sending to Family | Test-Reference | UAT         |

  @TorFX_PID-3798_TC02 @TorSendMoney_lot4
  ...
  @TorFX_PID-3798_TC03 @TorSendMoney_lot5
  ...
  @TorFX_PID-3798_TC04 @Torfx_iOS_sanity @TorSendMoney_lot5
  Scenario Outline: Bank Transfer-To verify Bank journey get successfully done when user click on back and forth page
    ...
    Examples: 
      | emailAddress    | password        | youPayCurrency | theyGetCurrency | amount | recipientType | recipientName   | country | currency | address | accountNo | bankCodeType | bankCode  | cardHolderName | cardNumber       | issueDate(MMYY) | expiryDate(MMYY) | cvv | paymentReason             | reference      | environment |
      | TorRegEmailId01 | CDRegEmailPass1 | GBP            | USD             | 200.00 | Individual    | Andrew Peterson | USA     | USD      | USAAdd  |  12345675 | ABA          | 083900363 | Peter          | 6759649826438453 |            1120 |             1125 | 555 | Buying Car / Boat / Plane | Test-Reference | UAT         |

  #| CDRegEmailId25 | CDRegEmailPass1 | EUR            | USD             | 200.00 | Individual    | Andrew Peterson | USA     | USD      | USAAdd  |  12345675 | ABA          | 083900363 | 3d             | 5555555555554444 |            1120 |             1125 | 555 | Sending to Family | Test-Reference | UAT         |
  @TorFX_PID-3798_TC05 @TorSendMoney_lot5
  ...
  Scenario Outline: 8.6.3 To verify that user lands on review page on click of back button or the device back button on UK Ts & C window
    ...
    Examples: 
      | emailAddress    | password        | youPayCurrency | theyGetCurrency | amount | recipientType | recipientName   | country | currency | address | accountNo | bankCodeType | bankCode  | cardHolderName | cardNumber       | issueDate(MMYY) | expiryDate(MMYY) | cvv | paymentReason     | reference      | environment |
      | TorRegEmailId03 | CDRegEmailPass1 | EUR            | USD             | 200.00 | Individual    | Andrew Peterson | USA     | USD      | USAAdd  |  12345675 | ABA          | 083900363 | Samsss Petro   | 6759649826438453 |            1120 |             1125 | 555 | Sending to Family | Test-Reference | SIT         |

  @TorFX_PID-3941_TC08 @TorSendMoney_lot5
  ...
  @TorFX_PID-3942_TC01 @TorSendMoney_lot5 @TorFX_iOS_2FA
  Scenario Outline: 9.1 ,8.10 To verify that data get mapped properly on confirmation page for wallet payment method.
    ...
    Examples: 
      | emailAddress    | password        | youPayCurrency | theyGetCurrency | amount | recipientType | recipientName  | country | currency | address | accountNo | bankCodeType | bankCode  | cardHolderName | cardNumber       | issueDate(MMYY) | expiryDate(MMYY) | cvv | paymentReason     | reference      | environment |
      | TorRegEmailId03 | CDRegEmailPass1 | EUR            | USD             | 150.00 | Individual    | carry Peterson | USA     | USD      | USAAdd  |  12345675 | ABA          | 083900363 | Samsss Petro   | 6759649826438453 |            1120 |             1125 | 555 | Sending to Family | Test-Reference | UAT         |

  @TorFX_PID-3942_TC02 @TorSendMoney_lot5 @TorFX_iOS_2FA
  Scenario Outline: To verify that when user makes the first payment he should only get the payment method ‘Bank Transfer  and other payment method should be disabled
    ...
    Examples: 
      | emailAddress    | password        | youPayCurrency | theyGetCurrency | amount | recipientType | recipientName  | country                  | currency | address | accountNo | bankCodeType | bankCode  | cardHolderName | cardNumber       | issueDate(MMYY) | expiryDate(MMYY) | cvv | paymentReason     | reference      | environment |
      | TorRegEmailId03 | CDRegEmailPass1 | CAD            | USD             | 150.00 | Individual    | denny Peterson | United States Of America | USD      | USAAdd  |  12345675 | ABA          | 083900363 | Samsss Petro   | 6759649826438453 |            1120 |             1125 | 555 | Sending to Family | Test-Reference | UAT         |

  @TorFX_PID-3942_TC03 @TorSendMoney_lot5
  ...
  @TorFX_PID-3942_TC04 @TorSendMoney_lot5 @TorFX_iOS_2FA
  Scenario Outline: 8.1 To verify that when user enters valid data on wallet payment method screen and click on continue button then user lands on review screen
    ...
    Examples: 
      | emailAddress    | password        | youPayCurrency | theyGetCurrency | amount | recipientType | recipientName  | country | currency | address | accountNo | bankCodeType | bankCode  | cardHolderName | cardNumber       | issueDate(MMYY) | expiryDate(MMYY) | cvv | paymentReason     | reference      | environment |
      | TorRegEmailId03 | CDRegEmailPass1 | EUR            | USD             | 150.00 | Individual    | zenny Peterson | USA     | USD      | USAAdd  |  12345675 | ABA          | 083900363 | Samsss Petro   | 6759649826438453 |            1120 |             1125 | 555 | Sending to Family | Test-Reference | UAT         |

  @TorFX_PID-3942_TC05 @TorSendMoney_lot5
  ...
  @TorFX_PID-3942_TC06 @Torfx_iOS_sanity @TorSendMoney_lot5
  Scenario Outline: To verify wallet journey get successfully done when user click on back and forth page.
    ...
    Examples: 
      | emailAddress    | password        | youPayCurrency | theyGetCurrency | amount | recipientType | recipientName   | country | currency | address | accountNo | bankCodeType | bankCode  | cardHolderName | cardNumber       | issueDate(MMYY) | expiryDate(MMYY) | cvv | paymentReason             | reference      | environment |
      | TorRegEmailId01 | CDRegEmailPass1 | EUR            | USD             | 200.00 | Individual    | Andrew Peterson | USA     | USD      | USAAdd  |  12345675 | ABA          | 083900363 | Peter          | 6759649826438453 |            1120 |             1125 | 555 | Buying Car / Boat / Plane | Test-Reference | UAT         |

  # | CDRegEmailId25 | CDRegEmailPass1 | EUR            | USD             | 200.00 | Individual    | Andrew Peterson | USA     | USD      | USAAdd  |  12345675 | ABA          | 083900363 | 3d             | 5555555555554444 |            1120 |             1125 | 555 | Sending to Family | Test-Reference | UAT         |
  @TorFX_PID-3942_TC07 @TorSendMoney_lot5 @TorFX_iOS_2FA
  Scenario Outline: CDLGB: To verify when sell currency is other than GBP or EUR and sell amount is greater than  available balance then only Bank Transfer payment method should be enabled
    ...
    Examples: 
      | emailAddress    | password        | youPayCurrency | theyGetCurrency | amount | recipientType | recipientName   | country                  | currency | address | accountNo | bankCodeType | bankCode  | cardHolderName | cardNumber       | issueDate(MMYY) | expiryDate(MMYY) | cvv | paymentReason             | reference      | environment |
      # | TorRegEmailId03 | CDRegEmailPass1 | AUD            | USD             | 12000.00 | Individual    | Andrew Peterson |  United States Of America       | USD      | USAAdd  |  12345675 | ABA          | 083900363 | Samsss Petro   | 6759649826438453 |            1120 |             1125 | 555 | Sending to Family | Test-Reference | UAT         |
      | TorRegEmailId01 | CDRegEmailPass1 | AUD            | USD             | 200.00 | Individual    | Andrew Peterson | United States Of America | USD      | USAAdd  |  12345675 | ABA          | 083900363 | Peter          | 6759649826438453 |            1120 |             1125 | 555 | Buying Car / Boat / Plane | Test-Reference | UAT         |

  @TorFX_PID-3942_TC08 @TorSendMoney_lot5
  Scenario Outline: To verify when sell currency is GBP or EUR and sell amount is greater than  available balance then Debit card payment method should be enabled and Wallet should be in disabled state.
    ...
    Examples: 
      | emailAddress    | password        | youPayCurrency | theyGetCurrency | amount   | recipientType | recipientName   | country | currency | address | accountNo | bankCodeType | bankCode  | cardHolderName | cardNumber       | issueDate(MMYY) | expiryDate(MMYY) | cvv | paymentReason     | reference      | environment |
      | TorRegEmailId03 | CDRegEmailPass1 | GBP            | USD             | 12000.00 | Individual    | Andrew Peterson | USA     | USD      | USAAdd  |  12345675 | ABA          | 083900363 | Samsss Petro   | 6759649826438453 |            1120 |             1125 | 555 | Sending to Family | Test-Reference | UAT         |

  @TorFX_PID-3942_TC09 @TorSendMoney_lot5
  Scenario Outline: CDLGB To verify when sell currency is other than GBP or EUR and sell amount less than or equal to available balance then Bank Transfer, Wallet should be in enabled state and Debitcard payment method in disabled state
    ...
    Examples: 
      | emailAddress    | password        | youPayCurrency | theyGetCurrency | amount  | recipientType | recipientName   | country | currency | address | accountNo | bankCodeType | bankCode  | cardHolderName | cardNumber       | issueDate(MMYY) | expiryDate(MMYY) | cvv | paymentReason     | reference      | environment |
      | TorRegEmailId03 | CDRegEmailPass1 | CAD            | USD             | 2000.00 | Individual    | Andrew Peterson | USA     | USD      | USAAdd  |  12345675 | ABA          | 083900363 | Samsss Petro   | 6759649826438453 |            1120 |             1125 | 555 | Sending to Family | Test-Reference | UAT         |

  @TorFX_PID-3942_TC10 @TorSendMoney_lot5
  Scenario Outline: To verify when sell currency is other than GBP or EUR and sell amount greater than or equal to available balance then bank transfer payment method should be enabled and debitcard
    ...
    Examples: 
      | emailAddress    | password        | youPayCurrency | theyGetCurrency | amount  | recipientType | recipientName   | country | currency | address | accountNo | bankCodeType | bankCode  | cardHolderName | cardNumber       | issueDate(MMYY) | expiryDate(MMYY) | cvv | paymentReason     | reference      | environment |
      | TorRegEmailId03 | CDRegEmailPass1 | CAD            | USD             | 8000.00 | Individual    | Andrew Peterson | USA     | USD      | USAAdd  |  12345675 | ABA          | 083900363 | Samsss Petro   | 6759649826438453 |            1120 |             1125 | 555 | Sending to Family | Test-Reference | UAT         |

  @TorFX_PID-3942_TC11 @TorSendMoney_lot5
  ...
  @TorFX_PID-3942_TC12 @TorSendMoney_lot5
  Scenario Outline: CDLGB To verify when sell currency is GBP or EUR and sell amount greater than available balance then Bank Transfer ,Debit Card should be eneabled state
    ...
    Examples: 
      | emailAddress    | password        | youPayCurrency | theyGetCurrency | amount   | recipientType | recipientName   | country | currency | address | accountNo | bankCodeType | bankCode  | cardHolderName | cardNumber       | issueDate(MMYY) | expiryDate(MMYY) | cvv | paymentReason     | reference      | environment |
      | TorRegEmailId03 | CDRegEmailPass1 | GBP            | USD             | 20000.00 | Individual    | Andrew Peterson | USA     | USD      | USAAdd  |  12345675 | ABA          | 083900363 | Samsss Petro   | 6759649826438453 |            1120 |             1125 | 555 | Sending to Family | Test-Reference | UAT         |

  @TorFX_PID-3942_TC13 @TorSendMoney_lot5
  ...
  @TorFX_PID-3939_TC52 @TorFX_FraudSight_SendMoney_Cycle1 @TorSendMoney_lot5
  Scenario Outline: 8.13 To verify that in send money flow user is able to perform journey by using existing non 3d card user land and on success page and data get mapped.
    ...
    Examples: 
      | emailAddress    | password        | youPayCurrency | theyGetCurrency | amount | recipientType | recipientName   | country | currency | address | accountNo | bankCodeType | bankCode  | cardHolderName | cardNumber       | issueDate(MMYY) | expiryDate(MMYY) | cvv | paymentReason     | reference      | environment |
      | TorRegEmailId03 | CDRegEmailPass1 | GBP            | USD             | 200.00 | Individual    | Andrew Peterson | USA     | USD      | USAAdd  |  12345675 | ABA          | 083900363 | Samsss Petro   | 5454545454545454 |            1120 |             1125 | 555 | Sending to Family | Test-Reference | UAT         |

  @TorFX_FraudSight_Scenario_05 @TorSendMoney_lot5
  Scenario Outline: 8.13 To verify that in send money flow user is able to perform journey by using existing non 3d invalid cvv card user land and on success page and data get mapped.
    ...
    Examples: 
      | emailAddress    | password        | youPayCurrency | theyGetCurrency | amount | recipientType | recipientName   | country | currency | address | accountNo | bankCodeType | bankCode  | cardHolderName | cardNumber       | issueDate(MMYY) | expiryDate(MMYY) | cvv | paymentReason     | reference      | environment |
      | TorRegEmailId03 | CDRegEmailPass1 | GBP            | USD             | 200.00 | Individual    | Andrew Peterson | USA     | USD      | USAAdd  |  12345675 | ABA          | 083900363 | Samsss Petro   | 5454545454545454 |            1120 |             1125 | 254 | Sending to Family | Test-Reference | UAT         |

  @TorFX_FraudSight_Scenario_06 @TorSendMoney_lot5
  Scenario Outline: 8.13 To verify that in send money flow user is able to perform journey by using existing 3d invalid cvv card user land and on success page and data get mapped.
    Given ios user installed the new TorFX app and launched successfully
    Then ios app should load the onboarding screen
    When ios user click on I already have an account? link
    Then ios user should navigate to login screen
  ...
  Scenario Outline: 8.13 To verify that in send money flow user is able to perform journey by
    ...
    Examples: 
      | emailAddress    | password        | youPayCurrency | theyGetCurrency | amount | recipientType | recipientName    | country                  | currency | address | accountNo                   | bankCodeType | bankCode                      | cardHolderName | cardNumber       | issueDate(MMYY) | expiryDate(MMYY) | cvv | paymentReason | reference      | environment |
      | TorRegEmailId08 | CDRegEmailPass1 | GBP            | EUR             | 200.00 | Individual    | Frances Shuffler | Spain                    | EUR      | USAAdd  |                    12451332 | IBAN         | ES91 2100 0418 4502 0005 1332 | Cgomes         | 4462030000000000 |            1120 |             1125 | 555 | Bill payments | Test-Reference | UAT         |
      | TorRegEmailId08 | CDRegEmailPass1 | GBP            | USD             | 200.00 | Company       | Frances Shuffler | United States Of America | USD      | USAAdd  |                    12457823 | ABA          |                     083900363 | Cgomes         | 4462030000000000 |            1120 |             1125 | 555 | Bill payments | Test-Reference | UAT         |
      | TorRegEmailId08 | CDRegEmailPass1 | GBP            | EUR             | 200.00 | Company       | Barclays Inc     | France                   | EUR      | USAAdd  | FR1420041010050500013M02606 | ABA          |                     083900363 | Cgomes         | 4462030000000000 |            1120 |             1125 | 555 | Bill payments | Test-Reference | UAT         |
      | TorRegEmailId08 | CDRegEmailPass1 | GBP            | CAD             | 200.00 | Individual    | Frances Shuffler | Canada                   | CAD      | USAAdd  |                    12345678 | ABA          |                     083900363 | Cgomes         | 4462030000000000 |            1120 |             1125 | 555 | Bill payments | Test-Reference | UAT         |
      | TorRegEmailId08 | CDRegEmailPass1 | GBP            | INR             | 200.00 | Company       | Tata Services    | India                    | INR      | USAAdd  |                    12345678 | ABA          |                     083900363 | Cgomes         | 4462030000000000 |            1120 |             1125 | 555 | Bill payments | Test-Reference | UAT         |
      | TorRegEmailId08 | CDRegEmailPass1 | GBP            | AUD             | 200.00 | Company       | ICICI Bank       | Australia                | AUD      | USAAdd  |                    12345678 | ABA          |                     083900363 | Cgomes         | 4462030000000000 |            1120 |             1125 | 555 | Bill payments | Test-Reference | UAT         |
      | TorRegEmailId08 | CDRegEmailPass1 | GBP            | ZAR             | 200.00 | Company       | TCS  Ltd         | South Africa             | ZAR      | USAAdd  |                    12345678 | ABA          |                     083900363 | Cgomes         | 4462030000000000 |            1120 |             1125 | 555 | Bill payments | Test-Reference | UAT         |
      | TorRegEmailId08 | CDRegEmailPass1 | GBP            | NZD             | 200.00 | Individual    | Andrew Peterson  | New Zealand              | NZD      | USAAdd  |                    12345678 | ABA          |                     083900363 | Cgomes         | 4462030000000000 |            1120 |             1125 | 555 | Bill payments | Test-Reference | UAT         |
      | TorRegEmailId08 | CDRegEmailPass1 | GBP            | SGD             | 200.00 | Individual    | Andrew Peterson  | Singapore                | SGD      | USAAdd  |                    12345678 | ABA          |                     083900363 | Cgomes         | 4462030000000000 |            1120 |             1125 | 555 | Bill payments | Test-Reference | UAT         |
      | TorRegEmailId08 | CDRegEmailPass1 | GBP            | EUR             | 200.00 | Individual    | Parle Inc        | United Kingdom           | EUR      | USAAdd  | GB29NWBK60161331926819      | ABA          |                     083900363 | Cgomes         | 4462030000000000 |            1120 |             1125 | 555 | Bill payments | Test-Reference | UAT         |
      | TorRegEmailId08 | CDRegEmailPass1 | EUR            | GBP             | 200.00 | Individual    | Parle Inc        | China                    | GBP      | USAAdd  |                    12345678 | ABA          |                     083900363 | Cgomes         | 4462030000000000 |            1120 |             1125 | 555 | Bill payments | Test-Reference | UAT         |
