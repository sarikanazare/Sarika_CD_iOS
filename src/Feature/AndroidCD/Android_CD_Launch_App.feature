@AppLaunch_CD_AndroidMob1CD

Feature: To test CD  app functionality 

    @PAD-2483_TC01_CDAndroidMob
    ...
    @PAD-2483 @PAD-2483_TC04 @Regression
   ...
   #Then android user is taken to the login screen with user name pre-filled
    ...
    Examples: 
      ...
      | CDLoginUser1 | CDRegEmailPass |
       
    @PAD-2483_TC05_CDAndroidMob
