...
Feature: Wallet
    ...
    Then user should be able to scroll down to see wallet list in android app
        Examples:
        | emailAddress     | password       |
        | CDWalletBigList  | CDRegEmailPass |
    ...
    Then android user should navigate to login screen
     ...
     Then android user navigates to wallet screen
         ...
         | CDWalletListUser  | CDRegEmailPass | EUR      |E           |
    ...
    Then android user should navigate to login screen
     ...
     Then list of available currency should be displayed in android aap
         ...
         | CDWalletListUser  | CDRegEmailPass | EARTT    |
   ...
   # When android user click on wallet currency "<currency>" from wallet screen page
    Then android user navigate to selected currency "<currencyWallet>" wallet detail screen
        ...
        | CDWalletListUser    | CDRegEmailPass | USD      | USD  Wallet    |
    ...
    Then no transaction message displayed in android app
        Examples:
        | emailAddress      | password       | currency | currencyWallet |
        | CDWalletListUser  | CDRegEmailPass | CAD      | CAD  Wallet    |
    ...
    Then send button should displayed in disabled state in android app
        Examples:
        | emailAddress      | password       | currency  |
        | CDWalletListUser  | CDRegEmailPass | CAD       |
    ...
    Then wallet transaction displayed in android app
        Examples:
        | emailAddress      | password       | currency | currencyWallet |
        | CDWalletListUser  | CDRegEmailPass | EUR      | EUR  Wallet    |
    ...
    Then android user navigate to selected currency "<currencyWallet>" wallet detail screen
        Examples:
        | emailAddress      | password       | currency  | currencyWallet |
        | CDWalletListUser  | CDRegEmailPass | AUD       | AUD  Wallet    |
    ...
    Then bank details screen displayed with correct details mapped in android app
        Examples:
        | emailAddress      | password       | currency |
        | CDWalletListUser  | CDRegEmailPass | USD      |
    ...
    Then android user navigates on activity page
        ...
        | CDWalletListUser  | CDRegEmailPass | EUR      | EUR  Wallet    |  4           |
    ...
    Then pay in currency "<PayInCCY>" tab should be displayed in android app
        ...
        | CDWalletListUser  | CDRegEmailPass | EUR      |  Pay in EUR    |
    ...
    Then android user should navigate to login screen
     ...
     Then android user navigates to wallet screen
         Examples:
         | emailAddress      | password       | currency |
         | CDWalletListUser  | CDRegEmailPass | GBP      |
    ...
    Then after two sec appropriate amount should be calculated in sell currency wallet in android app
        ...
        | CDWalletListUser | CDRegEmailPass  | GBP       |  2,000.00 |

    @PAD-3395_TC19 @sanity @regression
    ...
    Then minimum amount limit error message should be displayed to android user
        Examples:
        | emailAddress     | password        | currency | amount |
        | CDWalletListUser | CDRegEmailPass  | GBP      | 99.99  |

    @PAD-3395_20 @sanity @regression
    ...
    Then maximum allowed amount limit error message should be displayed to android user
        Examples:
        | emailAddress     | password        | currency | amount      |
        | CDWalletListUser | CDRegEmailPass  | GBP      | 225,001.00  |
    ...
    Then after two sec appropriate amount should be calculated in buy currency wallet in android app
        Examples:
        | emailAddress     | password        | currency  | amount    |
        | CDWalletListUser | CDRegEmailPass  | GBP       |  3,000.00 |
    ...
    Then minimum amount limit error message should be displayed to android user
        Examples:
        | emailAddress     | password       | currency  | amount   |
        | CDWalletListUser | CDRegEmailPass  | GBP       |  95.00   |
    ...
    Then maximum allowed amount limit error message should be displayed to android user
        Examples:
       | emailAddress     | password        | currency  | amount   |
       | CDWalletListUser | CDRegEmailPass  | GBP       | 55595.00 |
    ...
    Then after two sec appropriate amount should be calculated in buy currency wallet in android app
        ...
        | CDWalletListUser | CDRegEmailPass  | GBP       |  3,000.00 | 5,000.31    |
   ...
   Then android the app should load the onboarding screen
    ...
    And an auto timer of sixty seconds should start and rate should be refreshed and buying amount should be updated for wallet
        ...
        | CDWalletListUser | CDRegEmailPass  | USD       |  35,000.00 | DKK        |
    ...
    And an auto timer of sixty seconds should start and rate should be refreshed and selling amount should be updated for wallet
        Examples:
        | emailAddress     | password        | currency  | amount    |sellCurrency |
        | CDWalletListUser | CDRegEmailPass  | USD       |  3,000.00 |DKK          |
    ...
    Then android app should take the user to the buy currency screen with the selected currency "<sellCurrency>" in selling dropdown
        ...
        | CDWalletListUser  | CDRegEmailPass | GBP       |  USD         |
    ...
    Then android user navigates to buy currency screen
        Examples:
        | emailAddress     | password       | currency  | sellCurrency   |
        | CDWalletListUser | CDRegEmailPass | EUR       |  CZK           |
    ...
    Then continue button gets enabled in android app
        ...
        | CDWalletListUser  | CDRegEmailPass | EUR      |   150.00     |1000          |
    ...
    Examples:
       ...
       | CDWalletListUser  | CDRegEmailPass | EUR      |   00.10     |36000.10  |
    ...
    Then android user navigates to buy currency screen
     Examples:
       | emailAddress      | password       | currency |  amount   |
       | CDWalletListUser  | CDRegEmailPass | EUR      |   150.00  |
    ...
    Then continue button should get disabled in android app
        ...
        | CDWalletListUser | CDRegEmailPass | EUR      |   150.00  |  8453          | 05  |
    ...
    Then invalid issue date error message should be displayed to andoid user
         ...
         | CDWalletListUser | CDRegEmailPass | EUR      |   150.00  | Richard Smith,SKNDA1DartfordUK    | Tom K             | 01/20              |58544442222222   | 12/23     |
    ...
    Examples:
       | emailAddress     | password       | currency |  amount   |  cardLast4Digit|CVV   |
       | CDWalletListUser | CDRegEmailPass | EUR      |   150.00  |  8453          | 555  |

    @PAD-3396_TC40 @FraudSight @smokeTest @sanity @regression
    ...
    Then deal confirmation screen should be displayed with correct mapped details for add currency in android app
     ...
     |  CDLGB       |  CDWalletListUser | CDRegEmailPass | GBP      |   150.00  |  8453          | 555  | Richard Smith |6759649826438453  | 12/29            | 09/20     |
 #    |  CDLEU       | CDLEUEmailId  | CDRegEmailPass | GBP      |   150.00  |  8453          | 555  | Richard Smith |6759649826438453  | 12/29            | 09/20     |

    @PAD-3396_TC41 @FraudSight @smokeTest
    ...
    Then android user navigates to buy currency screen
     Examples:
      | Legal Entity| emailAddress     | password       | currency |  amount   |  cardLast4Digit|CVV   |
      | CDLGB       | CDWalletListUser | CDRegEmailPass | EUR      |   150.00  |  8453          | 555  |
      | CDLEU       | CDLEUEmailId     | CDRegEmailPass | EUR      |   150.00  |  8453          | 555  |
   ...
   # Then android app dispalyed the error for entered wrong cvv
         Examples:
       | Legal Entity | emailAddress        | password       | currency |  amount   |  cardLast4Digit|CVV   |cardHolderName     |cardNumber        | expiryDate(MMYY) | issuedate |
       | CDLGB        | CVVFailedGBEmailId  | CDRegEmailPass | GBP      |   150.00  |  8453          | 125  |Jack0990 Martin788 |6759649826438453  | 12/29            | 09/20      |
       | CDLEU        | CVVFailedEUEmailId  | CDRegEmailPass | GBP      |   150.00  |  8453          | 125  |George099 Albert098|6759649826438453  | 12/29            | 09/20     |


     @PAD-3648_TC44 @FraudSight @smokeTest
   ...
   # Then deal confirmation screen should be displayed with correct mapped details for add currency in android app
      Examples:
         | Legal Entity| emailAddress        | password       | currency |  amount   |  cardLast4Digit|CVV   |cardHolderName|cardNumber      | expiryDate(MMYY)|issuedate|
         |   CDLGB     |  CDWalletList3d | CDRegEmailPass | EUR      |   150.00  |  8453          | 555  |  3d          |6759649826438453|11/26            |12/20    |
         |   CDLEU     |  CDLEU3dEmailId     | CDRegEmailPass | EUR      |   150.00  |  8453          | 555  |  3d          |6759649826438453|11/26            |12/20    |

    @PAD-3648_TC45 @FraudSight @smokeTest
    ...
    #Then Done button should displayed in enabled state
        Examples:
        | Legal Entity| emailAddress       | password       | currency |  amount   |  cardLast4Digit|CVV   |
        |   CDLGB     | CDWalletList3d | CDRegEmailPass | EUR      |   150.00  |  8453          | 555  |
        |   CDLEU     | CDLEU3dEmailId     | CDRegEmailPass | EUR      |   150.00  |  8453          | 555  |
   ...
   # Then android user click on submit from 3dsceure screen
    Then android app dispalyed the error for entered wrong cvv
        Examples:
       | emailAddress        | password       | currency |  amount   |  cardLast4Digit|CVV   |
       | CVVFailedGBEmailId  | CDRegEmailPass | GBP      |   150.00  |  8453          | 125  |
   ...
   # Then deal confirmation screen should be displayed with correct mapped details for add currency in android app
        Examples:
        | emailAddress       | password       | currency |  amount   |  cardLast4Digit|CVV   |
        | CDWalletList3d | CDRegEmailPass | GBP      |   150.00  |  8453          | 555  |
    ...
    Then sell and buy amount get zero in android app
        Examples:
        | emailAddress     | password        | currency | minamount |maxamount |
        | CDWalletListUser | CDRegEmailPass  | GBP      | 99.99     | 55000.00 |
    ...
    @PAD-5588_TC51
    Scenario Outline: (Buy currency-Fx)CDLGB To verify when sell currency is GBP/EUR and sell amount less than or equal to available balance (non zero balance) then all payment methods is in active state
    Given android user installed the new CD app and launched successfully
    Then android the app should load the onboarding screen
    When android user click on I already have an account? link
    Then android user should navigate to login screen
    ...
    Examples:
    | LegalEntity | emailAddress     | password       | amount |sellCurrency | currency  |
    |    CDLGB    | CDWalletListUser | CDRegEmailPass | 250.00 |GBP          |    USD    |
    |    CDLEU    | CDLEUEmailId     | CDRegEmailPass | 250.00 |GBP          |    USD    |
    |    CDINC    | CDINCEmailId     | CDRegEmailPass | 350.00 |USD          |    EUR    |


    @PAD-5588_TC52
    Scenario Outline: (Buy currency-Fx) CDLGB To verify when sell currency is other than GBP/EUR and sell amount less than or equal to available balance then wallet and Debit card payment method disabled
    Given android user installed the new CD app and launched successfully
    Then android the app should load the onboarding screen
    When android user click on I already have an account? link
    Then android user should navigate to login screen
    ...
    Then android user observed Wallet payment method in active state
      Examples:
      | LegalEntity | emailAddress     | password       | amount   |sellCurrency | currency  |
      | CDLGB       | CDWalletListUser | CDRegEmailPass | 22650.00 |USD          |    EUR    |
      | CDLEU       | CDLEUEmailId     | CDRegEmailPass | 22650.00 |USD          |    EUR    |
      | CDLCA       | CDLCAEmailId     | CDRegEmailPass | 350.00   |USD          |    EUR    |
      | CDINC       | CDINCEmailId | CDRegEmailPass | 350.00   |USD          |    EUR    |


    @PAD-5588_TC53
    Scenario Outline: (Buy currency-Fx) CDLGB To verify when sell currency is GBP/EUR and sell amount greater than available balance (non zero balance) then all payment methods is in active state
    Given android user installed the new CD app and launched successfully
    Then android the app should load the onboarding screen
    When android user click on I already have an account? link
    Then android user should navigate to login screen
    ...
    Examples:
          | LegalEntity | emailAddress     | password       | amount   |sellCurrency | currency  |
          | CDLGB       |CDWalletListUser  | CDRegEmailPass | 22550.00 |CAD          |    GBP    |
          | CDLEU       | CDLEUEmailId     | CDRegEmailPass | 22650.00 |CAD          |    EUR    |
          | CDINC       | CDINCEmailId     | CDRegEmailPass | 350.00   |CAD          |    EUR    |

    @PAD-5588_TC54
    Scenario Outline: (Buy currency-Fx) CDLGB To verify when sell currency is other than GBP/EUR and sell amount greater than available balance then wallet and card payment methods is in disable state
    Given android user installed the new CD app and launched successfully
    Then android the app should load the onboarding screen
    When android user click on I already have an account? link
    Then android user should navigate to login screen
    ...
    Examples:
          | LegalEntity | emailAddress      | password       | amount    |sellCurrency | currency  |
          | CDLGB       | CDWalletListUser  | CDRegEmailPass | 2190.00   |CAD          |    EUR    |
          | CDLEU       | CDLEUEmailId      | CDRegEmailPass | 650.00    |CAD          |    EUR    |
          | CDLCA       | CDLCAEmailId      | CDRegEmailPass | 1650.00   |CAD          |    EUR    |
          | CDINC       | CDINCEmailId      | CDRegEmailPass | 350.00    |CAD          |    EUR    |
    ...
    Examples:
      | emailAddress      | password       | currency  | sellCurrency |
      | CDWalletListUser  | CDRegEmailPass | EUR       | GBP          |
    ...
    Examples:
      ...
      | CDWalletListUser | CDRegEmailPass | CAD        |   EUR        | Richard Smith,SKNDA1DartfordUK| Richard Smith   |6759649826438453  | 12/29           | 09/20     |
    ...
    Examples:
      ...
      | CVVFailedGBEmailId  | CDRegEmailPass | CAD        |   EUR        |8453           |

    @PAD-3398_TC59 @FraudSight @smokeTest
    ...
    Then deal confirmation screen should be displayed with correct mapped details for buy currency fx in android app
      Examples:
        | Legal Entity| emailAddress     | password       | currency   | sellCurrency |amount | cardLast4Digit |CVV |
        | CDLGB       | CDWalletListUser | CDRegEmailPass | USD        |   GBP        |280.00 | 8453           | 555|
        | CDLEU       | CDLEUEmailId     | CDRegEmailPass | USD        |   GBP        |280.00 | 8453           | 555|
   ...
   Examples:
      | emailAddress      | password       | currency  |
      | CDWalletListUser  | CDRegEmailPass | EUR       |
    ...
    Then sell currency dislayed as payment currency in android app
     Examples:
      ...
      | CDWalletListUser  | CDRegEmailPass | GBP          |    USD    |100.00    |
   ...
   Examples:
    ...
    Examples:
      ...
      | CDWalletListUser  | CDRegEmailPass | GBP          |    EUR    |

    @PAD-3399_TC64 @smokeTest
    ...
    Examples:
      ...
      | CDWalletListUser  | CDRegEmailPass | 250.00 |USD          |    GBP    |

    @PAD-3398_TC65 @sanity @regression
    ...
    Examples:
      | emailAddress      | password        |sellCurrency | currency  | amount |
      | CDWalletListUser  | CDRegEmailPass  |EUR          |    USD    |130.00  |

     @PAD-3399_TC66 @smokeTest @sanity @regression
    ...
    Examples:
      | emailAddress      | password       | sellCurrency | currency  | amount   |
      | CDWalletListUser  | CDRegEmailPass | EUR          |    GBP    |180.00    |
    ...
    Then cvv field observed blank in android app
     Examples:
       ...
       | CDWalletListUser  | CDRegEmailPass | USD        |   GBP        |180.00 | 8453           | 555|

    @PAD-3396_TC68 @FraudSight @smokeTest @sanity @regression
    ...
    Then deal confirmation screen should be displayed with correct mapped details for buy currency fx in android app
     Examples:
    | Legal Entity | emailAddress      | password       | currency |  amount   |  cardLast4Digit|CVV   |sellCurrency | cardHolderName  |cardNumber        | expiryDate(MMYY) | issuedate |
    | CDLGB        | CDWalletListUser  | CDRegEmailPass | EUR      |   250.00  |  8453          | 555  | GBP         |Richard Smith    |6759649826438453  | 12/29            | 09/20     |
   # |  CDLEU       | CDLEUEmailId  | CDRegEmailPass | EUR      |   250.00  |  8453          | 555  | GBP         |Richard Smith    |6759649826438453  | 12/29            | 09/20     |
    ...
    #Then android app dispalyed the error for entered wrong cvv
     Examples:
    | Legal Entity | emailAddress       | password       | currency |  amount   |  cardLast4Digit|CVV   |sellCurrency | cardHolderName      |cardNumber        | expiryDate(MMYY) | issuedate |
    |  CDLGB       | CVVFailedGBEmailId | CDRegEmailPass | EUR      |   150.00  |  8453          | 125  | GBP         |Jack0990 Martin788   |6759649826438453  | 12/29            | 09/20     |
   # |  CDLEU       | CVVFailedEUEmailId | CDRegEmailPass | EUR      |   150.00  |  8453          | 125  | GBP         |George099 Albert098  |6759649826438453  | 12/29            | 09/20     |
    ...
    Examples:
      | emailAddress      | password       | sellCurrency | currency  | amount   |
      | CDWalletListUser  | CDRegEmailPass | GBP          |    USD    |250.00    |
   ...
   Examples:
      ...
      | CDWalletListUser  | CDRegEmailPass | 1,200.00 | USD       | GBP          |

      @PAD-3398_TC73 @FraudSight
  ...
  #  Then deal confirmation screen should be displayed with correct mapped details for buy currency fx in android app
      Examples:
       | Legal Entity | emailAddress       | password       | currency   | sellCurrency |amount | cardLast4Digit |CVV |cardLast4DigitUpdated |
       | CDLGB        | CDWalletList3d | CDRegEmailPass | EUR        |   GBP        |180.00 | 8453           | 555|      1111            |
     #  | CDLEU        | CDLEU3dEmailId     | CDRegEmailPass | EUR        |   GBP        |180.00 | 8453           | 555|      1111            |

      @PAD-3398_TC74 @FraudSight @smokeTest
   ...
   #Then android user navigates to buy currency screen
      Examples:
       | Legal Entity | emailAddress       | password       | currency   | sellCurrency |amount | cardLast4Digit |CVV |cardHolderName |cardNumber        | expiryDate(MMYY) | issuedate |
       |    CDLGB     | CDWalletList3d | CDRegEmailPass | EUR        |   GBP        |180.00 | 8453           | 555| 3d            |6759649826438453  | 12/29            | 09/20     |
    #   |    CDLEU     | CDLEU3dEmailId     | CDRegEmailPass | EUR        |   GBP        |180.00 | 8453           | 555| 3d            |6759649826438453  | 12/29            | 09/20     |
    ...
    Examples:
      | emailAddress      | password       | currency  | amount    |
      | CDWalletListUser  | CDRegEmailPass | EUR       |250.00     |
    ...
    Examples:
      | emailAddress      | password       | currency  | amount       |
      | CDWalletListUser  | CDRegEmailPass | AUD       |90000.00      |
    ...
    Then android user navigates to send from wallet page
      Examples:
        | emailAddress      | password       | currency  | amount    |
        | CDWalletListUser  | CDRegEmailPass | EUR       |120.00     |
    ...
    Then android user navigates to send from wallet page
     Examples:
      | emailAddress      | password       | currency  | amount    |
      | CDWalletListUser  | CDRegEmailPass | EUR       |120        |
    ...
    Then android user land on Payment Method screen
    Examples:
      | emailAddress      | password       | currency |Type      | recipientName | country  |  accountNumber                | environment |
      | CDWalletListUser  | CDRegEmailPass | EUR      |Individual| Samie Will    | France   | FR1420041010050500013M02606   | UAT         |
    ...
    Then android user should land on select recipient screen
	  ...
	  Then android user land on Payment Method screen
    Examples:
      | emailAddress      | password       | currency  |recipientName | accountNo|
      | CDWalletListUser  | CDRegEmailPass | EUR       |Jack Smith    | 123456   |
    ...
    Examples:
      | emailAddress      | password       | currency  |amount |buyCurrency| recipientName | accountNo|
      | CDWalletListUser  | CDRegEmailPass | EUR       |450    |EUR        | Jack Smith    | 123456   |
    ...
    Then user should navigates to review page
      Examples:
        | emailAddress      | password       | currency  |buyCurrency| recipientName | accountNo|
        | CDWalletListUser  | CDRegEmailPass | EUR       |EUR        |  Jack Smith   | 123456   |
    ...
    Then android user observe the parameter on Review screen send wallet
     Examples:
      ...
      | CDWalletListUser  | CDRegEmailPass | EUR       |  5.00    |      EUR   | Jack Smith    | FR1420041010050500013M02606|
    ...
    @PAD-3392_TC88 @smokeTest @sanity @regression
    ...
    Then android user navigates to "<currency>" wallet  screen
     Examples:
      | emailAddress      | password       | currency  |amount |buyCurrency| recipientName | accountNo|
      | CDWalletListUser  | CDRegEmailPass | EUR       |02.00  |EUR        | Jack Smith    | 123456   |
    ...
    Then cancel payment confirmation popup displayed on android device
     Examples:
       | emailAddress        | password       | currency |  amount   |  cardLast4Digit|CVV   |
       | CDWalletList3d      | CDRegEmailPass | EUR      |   150.00  |  8453          | 555  |
