@DebitCard_AndroidTorFx
Feature: Debit Card :

  @PAD-2803_TC89_AndroidTorFx
  ...
  Scenario Outline: 2.4 To verify all the details of a selected card has been displayed in a new screen
    ...
    Examples: 
      ...
      | TorFxRegEmailId | TorFxRegEmailPass |           8453 | Name-saira Peter,Card no-**** **** **** 8453,Expiry date-12/30,IssueDate-09/20,Adress-2HeatherlandsAscotBerkshireSL50AN |

  @PAD-2803_TC94_AndroidTorFx
  Scenario Outline: 2.5 To check that user navigates to main account screen when user closes the debit card screen
    Given android user installed the new TorFx app and launched successfully
    Then android the app should load the onboarding screen
    When android user click on I already have an account? link
  ...
  Scenario Outline: 4.1 To verify pre populated card holder name and billing address is as per logged in user and card details are blank on add card screen.
    ...
    Examples: 
      ...
      | TorFxRegEmailId | TorFxRegEmailPass  | saira Peter,2HeatherlandsSL50ANAscotUK |

  @PAD-2803_TC96_AndroidTorFx  @TorFxregression @TorFxSanity
  Scenario Outline: 4.2 To verify application allow user to add debit card with the last name which matches with available contacts last name of the account
    ...
    Examples: 
      ...
      | TorFxRegEmailId | TorFxRegEmailPass |saira Peter,2HeatherlandsSL50ANAscotUK |saira Peter     | 6759649826438453 | 12/30            | 09/20     |

#Bug Raised for this:PAD-4241
  @PAD-2803_TC99_AndroidTorFx
  ...
  Scenario Outline: 4.11  To verify invalid expiry date error message
    ...
    Examples: 
      ...
      | TorFxRegEmailId | TorFxRegEmailPass | saira Peter,2HeatherlandsSL50ANAscotUK | 01/20|

  
 
  @PAD-2803_TC107_AndroidTorFx
  ...
  Scenario Outline: 3.7 To verify add debit card functionality with manual address entry when user uses pre populated country value and rest of the address by using search option.
    ...
    Examples: 
      ...
      | TorFxRegEmailId | TorFxRegEmailPass | Cab Building, Campus East Welwyn Garden City, AL8 6LY | saira Peter | 6759649826438453 | 12/30 | 09/20 |


  @PAD2920_TC112_AndroidTorFx
  Scenario Outline: 3.7 To verify add debit card functionality with manual address entry when user uses pre populated country and rest of the address enters by manually.
    ...
    Examples: 
      ...
      | TorFxRegEmailId | TorFxRegEmailPass | saira Peter    | 6759649826438453 | 12/30            |    09/20  | Flat 2,Wickliffe Court,UK,London,9999999 | United Kingdom   |


  @PAD2920_TC113_AndroidTorFx
  Scenario Outline: 3.7 To verify add debit card functionality with manual address entry when user enters country and address details manually.
    ...
    Examples: 
      | emailAddress | password       | cardHolderName | cardNumber       | expiryDate(MMYY) | issuedate | Address                           | country   |
      | TorFxRegEmailId | TorFxRegEmailPass | saira Peter    | 6759649826438453 | 12/30            | 09/20     | Calle B,Cabaleiros,Tordoia,999999 | Argentina |

  @PAD2920_TC114_AndroidTorFx
  Scenario Outline: 3.7  To verify add debit card functionality with manual address when user enters country and rest of the address details by using search option.
    ...
    Examples: 
     | emailAddress | password       | cardHolderName | cardNumber       | expiryDate(MMYY) | issuedate | address                                | country |
		 | TorFxRegEmailId | TorFxRegEmailPass | saira Peter    | 6759649826438453 | 12/30            | 09/20     | Calle B Curtis (Santaia), 15379 Curtis | Spain   |

  
  @PAD2920_TC116_AndroidTorFx
  ...
  Scenario Outline: 3.7 To verify save button should be disabled when user click on edit address
    ...
    Examples: 
      ...
      | TorFxRegEmailId | TorFxRegEmailPass  | saira Peter    | 6759649826438453 | 12/30            | 09/20     |
 
    @PAD-3561_TC205_AndroidTorFx
    ...
    Examples: 
      ...
      | TorFxRegEmailId | TorFxRegEmailPass | saira Peter,2HeatherlandsSL50ANAscotUK | Tom k             | saira Peter    |


  @PAD-3561_TC206_AndroidTorFx
  Scenario Outline: 2.2, 2.3.2 To verify error message gets displayed when user enters invalid data in Card number field and when users revisit the same field again and corrects the data error message gets removed
    ...
    Examples: 
      ...
      | TorFxRegEmailId  | TorFxRegEmailPass | saira Peter,2HeatherlandsSL50ANAscotUK |   123456987012345 | 6759649826438453 |


   @PAD-2803_TC207_AndroidTorFx
   Scenario Outline: 2.2, 2.3.3  To verify error message for invalid issue date should be removed without changing focus
    ...
    Examples: 
      ...
      | TorFxRegEmailId  | TorFxRegEmailPass | saira Peter,2HeatherlandsSL50ANAscotUK | 12/30           | 09/20          |

    @PAD-3561_TC208_AndroidTorFx
    ...
    Examples: 
      ...
      | TorFxRegEmailId  | TorFxRegEmailPass | saira Peter,2HeatherlandsSL50ANAscotUK    | 09/20                | 12/30           |

    @PAD-3561_TC209_AndroidTorFx
    ...
    Examples: 
      ...
      | TorFxRegEmailId  | TorFxRegEmailPass | 6759649826438453 |

 
  @PAD-3561_TC212_AndroidTorFx
  Scenario Outline: 2.4.4 To verify mandatory fields error message should be removed after entering expiry date
    ...
    Examples: 
      ...
      | TorFxRegEmailId  | TorFxRegEmailPass | 02/30           |

  @PAD-3561_TC213_AndroidTorFx
  Scenario Outline: 2.4.5o verify add debit card functionality with manual address entry when user enters country and address details manually.
    ...
    Examples: 
       | emailAddress    | password          |cardHolderName | cardNumber       | expiryDate(MMYY) | issuedate | country  | address      |
       | TorFxRegEmailId | TorFxRegEmailPass | saira Peter   | 6759649826438453 | 09/20            | 12/30     | Spain    |canadaAddress |          
 
  @PAD-3561_TC214_AndroidTorFx
  Scenario Outline: 2.4.6 To verify mandatory fields error message should be removed after entering country
    ...
    Examples: 
      ...
      | TorFxRegEmailId  | TorFxRegEmailPass | United Kingdom  |

      
  @PAD-3670_TC215_AndroidTorFx
  ...
  Examples: 
      | emailAddress    | password          | address | cardHolderName | cardNumber       | expiryDate(MMYY) | issuedate |
      | TorFxRegEmailId | TorFxRegEmailPass | Cab Building, Campus East Welwyn Garden City, AL8 6LY | saira Peter | 6759649826438453 | 09/20            | 12/30     |
      | TorFxRegEmailId | TorFxRegEmailPass | ^&**% | saira Peter | 6759649826438453 | 09/20            | 12/30     |
   
  @PAD-3670_TC216_AndroidTorFx
  ...
  Then android user should be on same selected card view screen
   Examples: 
      | emailAddress    | password          | address | cardHolderName | cardNumber       | expiryDate(MMYY) | issuedate |
      | TorFxRegEmailId | TorFxRegEmailPass | (((())))| John Morgan    | 6759649826438453 | 09/20            | 12/30     |
      
  @PAD-3670_TC217_AndroidTorFx
